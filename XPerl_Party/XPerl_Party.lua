...
function XPerl_Party_Events_OnLoad(self)
	...
	local events = {"PLAYER_ENTERING_WORLD", "PARTY_MEMBER_ENABLE", "PARTY_MEMBER_DISABLE", "RAID_ROSTER_UPDATE", "PARTY_MEMBERS_CHANGED",
...
-- RAID_ROSTER_UPDATE
function XPerl_Party_Events:RAID_ROSTER_UPDATE()
	CheckRaid()
end
XPerl_Party_Events.GROUP_ROSTER_UPDATE = XPerl_Party_Events.RAID_ROSTER_UPDATE
