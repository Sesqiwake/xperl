-- X-Perl UnitFrames
-- Original author: Zek <Boodhoof-EU>
-- Sirus.su fork: Sesqiwake
-- License: GNU GPL v3, 29 June 2007 (see LICENSE.txt)
--Russian localization file translated by StingerSoft
if (GetLocale() == "ruRU") then

XPerl_ProductName	    = "|cFFD00000X-Perl|r Фреймы Игроков"
XPerl_SirusTag		    = "|cffeda55fАдаптировано под Sirus.su|r"
XPerl_Description	    = XPerl_ProductName.." — "..XPerl_SirusTag.." ("..XPerl_Author..")"
...
XPerl_LongDescription	= "Замена стандартных фреймов игрока, питомца, группы, цели, цели цели, фокуса и рейда.\n"..
	...
	"Изменения 3.1.1:\n"..
	"• Скрытие выбранных баффов/дебаффов на игроке/группе/цели/фокусе (вкладка «Все»)\n"..
	...
	"• Исправлены описания бафов в тултипах\n"..
	"• Исправлена прогрузка иконок групп рейда при смене слоёв\n"..
	"• Исправлена загрузка рейд-фреймов и просадка FPS"
	...
	XPERL_MINIMENU_PROFILES		= "Профили"
	XPERL_MINIMAP_PROFILES_HINT	= "Профили раскладки (общие для аккаунта)"
