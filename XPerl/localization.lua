...
XPerl_OriginalAuthor	= "|cFFFF8080Zek|r"
...
XPerl_LongDescription	= "UnitFrame replacement for Player, Pet, Party, Target, Target's Target, Focus and Raid.\n"..
	...
	"• Fixed buff tooltip descriptions\n"..
	"• Fixed raid group icon refresh when switching layout layers\n"..
	"• Fixed raid frames not loading and related FPS drops"
...
XPERL_MINIMENU_PROFILES = "Profiles"
XPERL_MINIMAP_PROFILES_HINT = "Layout profiles — pick one from the list"
XPERL_CONF_PROFILES_APPLIED = "Profile applied: %s"
XPERL_CONF_PROFILES_SAVED = "Profile saved: %s"
XPERL_CONF_PROFILES_NOT_FOUND = "Profile not found: %s"
